...
<table id="tableauType">
	...
	?>
		<tr>
			...
			<td><a href="#" onclick="window.open('include/service/modifier_service.php?id=<?php echo $ligne['id_serviceE']; ?>&nom=<?php echo $ligne['nom_serviceE']; ?>', 'wclose', 'width=500,height=300,toolbar=no,status=no,left=20,top=30'); Location:reload();">Modifier</a></td>
		</tr>	
	<?php
	}
	?>
