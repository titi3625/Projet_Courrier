...
<body>
	...
	$sql = 'SELECT id_courrier, objet_courrier, date_courrier, observation, id_accuse_de_reception, nom_nature, nom_type, courrier.num_envoi, expediteur.id_expediteur, nom_expediteur, service_expediteur.nom_serviceE AS serviceE, destinataire.id_destinataire, nom_destinataire, service_destinataire.nom_serviceD AS serviceD
