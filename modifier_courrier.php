...
if(isset($_POST)) {
	...
	if(isset($expeModif) && !empty($expeModif)) {
		...
		$requeteHisto = "INSERT INTO histo_courrier VALUES('', '".$idModif."', '".$_SESSION['login']."', '".date('Y-m-d H:i:s')."', '".$objetModif."', '".$observModif."', '".$typeModif."', '".$expeModif."', '".$serviceExpe."', '".$destModif."', '".$serviceDest."')";
		try {
